...
export const Content = ({ feed, handleClickOpen } : { feed: FeedModel, handleClickOpen: () => void }) => {
    return (
        <div style={{ backgroundColor: "white", width: "800px", borderRadius: "20px", boxShadow: "0px 4px 4px rgba(0, 0, 0, 0.11)" }}>
          <div style={{ padding: "30px" }}>
            <div style={{ float: "left", marginRight: "18px" }}>
              <img src="" style={{ width: "80px", height: "80px", borderRadius: "40px", overflow: "hidden", backgroundColor: "#EEEEEE" }} onClick={handleClickOpen} />
            </div>
